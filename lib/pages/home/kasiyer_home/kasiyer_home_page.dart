...
class KasiyerHomePage extends StatelessWidget {
  ...
  static const List<_MenuItem> _kasiyerMenuItems = [
    ...
    _MenuItem(title: 'Cari Hesap Yönetimi', route: AppRoutes.cariHesapYonetimi, icon: Icons.people),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Kasiyer Panel', style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: false,
